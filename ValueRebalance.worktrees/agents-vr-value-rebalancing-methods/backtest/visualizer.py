...
class VRVisualizer:
    ...
    def create_chart(self) -> str:
        ...
        return fig.to_html(include_plotlyjs='cdn', div_id="backtest-chart")
    ...
    def get_summary(self) -> dict:
        ...
        return {
            ...
            "final_shares": f"{(self.result.daily_data[-1].evaluation - self.result.daily_data[-1].pool) / self.result.daily_data[-1].close_price:.2f}" if self.result.daily_data and self.result.daily_data[-1].close_price > 0 else "0",
        }
